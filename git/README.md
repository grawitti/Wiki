...
* [Коммит](#1)
	* [Создание](#11)
	* [Переход между коммитами](#12)
	* [Отмена изменений](#13)
	* [Добавление изменений](#14)
	* [Объединение](#15)
* [Ветвление](#2)
	* [Просмотр доступных веток](#21)
	* [Создание новой ветки](#22)
	* [Добавление изменений в ветку](#23)
	* [Слияние веток](#24)
	* [Конфликт версий](#25)
	* [Переименование ветки](#26)
	* [Удаление ветки](#27)
* [Модули](#3)
	* [Загрузка субмодулей](#31)
	* [Обновление субмодулей](#32)
...
### <a name='12'></a>Переход между коммитами
...
### <a name='14'></a>Добавление изменений
...
## <a name='2'></a>Ветвление

### <a name='21'></a>Просмотр доступных веток
...
### <a name='22'></a>Создание новой ветки
...
### <a name='23'></a>Добавление изменений в ветку
...
### <a name='26'></a>Переименование ветки
...
### <a name='31'></a>Загрузка субмодулей

    git submodule update --init --recursive

### <a name='32'></a>Обновление субмодулей
